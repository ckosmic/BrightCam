...
@class SBDashBoardCameraPageViewController; @class SBDashBoardViewController; @class SpringBoard; @class SBBrightnessController; @class UIScreen; 
...
static __inline__ __attribute__((always_inline)) __attribute__((unused)) Class _logos_static_class_lookup$UIScreen(void) { static Class _klass; if(!_klass) { _klass = objc_getClass("UIScreen"); } return _klass; }static __inline__ __attribute__((always_inline)) __attribute__((unused)) Class _logos_static_class_lookup$SBBrightnessController(void) { static Class _klass; if(!_klass) { _klass = objc_getClass("SBBrightnessController"); } return _klass; }
#line 18 "Tweak.x"
